...
HTTP::HTTP(std::string uri, bool keepAlive)
    : _connection(0), _sockfd(-1), _keepAlive(keepAlive), _keepAliveTimeout(60), _lastRequest(0) {
...
bool HTTP::request(const char* method, const char* endUrl, const char* data, boost::property_tree::ptree* jOutput,
...
bool HTTP::request(const char* method, const char* endUrl, const char* data, std::string& output,
                   const char* content_type) {
    Result result;
...
unsigned int HTTP::request(const char* method, const char* endUrl, const char* data, std::string& output,
