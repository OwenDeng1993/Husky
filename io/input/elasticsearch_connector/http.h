...
class HTTP {
    public:
        ...
        bool request(const char* method, const char* endUrl, const char* data, boost::property_tree::ptree* root, const char* content_type = _APPLICATION_JSON);

        /// Generic request that parses the result in Json::Object.
        unsigned int request(const char* method, const char* endUrl, const char* data, boost::property_tree::ptree* root, Result& result, const char* content_type = _APPLICATION_JSON);
        ...
        inline unsigned int get(const char* endUrl, const char* data, boost::property_tree::ptree* root){
            Result result;
            return request("GET", endUrl, data, root, result);
        }

        /// Generic head request to node.
        inline unsigned int head(const char* endUrl, const char* data, boost::property_tree::ptree* root){
            Result result;
            return request("HEAD", endUrl, data, root, result);
        }

        /// Generic put request to node.
        inline unsigned int put(const char* endUrl, const char* data, boost::property_tree::ptree* root){
            Result result;
            return request("PUT", endUrl, data, root, result);
        }

        /// Generic post request to node.
        inline unsigned int post(const char* endUrl, const char* data, boost::property_tree::ptree* root){
            Result result;
            return request("POST", endUrl, data, root, result);
        }

        /// Generic delete request to node.
        inline unsigned int remove(const char* endUrl, const char* data, boost::property_tree::ptree* root){
            Result result;
            return request("DELETE", endUrl, data, root, result);
        }

        /// Generic post request to node.
        inline unsigned int rawpost(const char* endUrl, const char* data, boost::property_tree::ptree* root){
            Result result;
