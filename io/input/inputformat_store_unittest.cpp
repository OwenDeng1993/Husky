...
TEST_F(TestInputFormatStore, ElasticsearchInputFormat) {
    auto& infmt1 = InputFormatStore::create_elasticsearch_inputformat("192.168.50.5:9200",false);
    EXPECT_EQ(InputFormatStore::size(), 1);
    auto& infmt2 = InputFormatStore::create_elasticsearch_inputformat("192.168.50.5:9200",false);
    EXPECT_EQ(InputFormatStore::size(), 2);
    InputFormatStore::drop_all_inputformats();
}
